...
import com.in28minutes.microservices.currencyconversionservice.util.environment.EnvironmentConfigurationLogger;
		...
		try
		{
			...
			while (e.hasMoreElements())
			{
				...
				if (header.startsWith("x-") || header.startsWith("murali-"))
				{
					...
					LOGGER.info("Currency-Conversion: Adding to Header:: {} - {}", header, value);
				}
			}
		}
